...
export default () => {
    ...
    function onItemOptionSearchTest(_item_code: string) {
        const item_options: DefaultOptionType[] = [];
    ...
    function onSupplierOptionSearchTest(_supplier_code: string) {
        const supplier_options: DefaultOptionType[] = [];
        for (let i = 1; i <= Math.floor(Math.random() * 10 + 1); i++) {
            supplier_options.push({
    ...
    async function createOrder() {
        ...
        const result = await api.OrderOutboundQuickAdd(item_details);
            ...
            <Row className="hc_panel" style={{ backgroundColor: "#eee" }}>
                ...
                <Col span={5}>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            window.location.href = "/workbench/order/outbound";
                        }}
                    >
                        返回上一层
                    </Button>
