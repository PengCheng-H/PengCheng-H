...
interface IHCInboundOrderAllocateProps {
    item_code?: string
    supplier_code?: string
    outbound_order_status?: number[]
}

interface IHCInboundOrderAllocateStates {
    item_code: string
...
export default class HCInboundOrderAllocate extends React.Component<IHCInboundOrderAllocateProps, IHCInboundOrderAllocateStates> {
    state: IHCInboundOrderAllocateStates

    constructor(props: IHCInboundOrderAllocateProps) {
        super(props)
        this.state = {
