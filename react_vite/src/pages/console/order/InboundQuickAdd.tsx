...
import { IHCItem, IHCInboundOrderQuickAddItem } from "src/interfaces/interface"
...
interface InboundQuickAddProps {
    quickAddInboundItem: IHCInboundOrderQuickAddItem | undefined;
    setQuickAddInboundItem: (quickAddInboundItem: IHCInboundOrderQuickAddItem) => void;
}

export default function InboundQuickAdd(props: InboundQuickAddProps) {
    ...
    useEffect(() => {
        props.setQuickAddInboundItem({ supplier_code: supplierCode, items: newItemList });
    }, [newItemList]);
    ...
    const onAddItemOk = async () => {
        ...
        const newItem: IHCNewItem = { ...get_item_result.data, id: itemId, quantity: itemQuantity };
