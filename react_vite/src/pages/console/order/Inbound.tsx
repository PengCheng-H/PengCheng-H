...
import { IHCInboundOrder, IHCItem, IHCSupplier } from "src/interfaces/interface";
...
export default function OrderInbound() {
    ...
    // const [curOrder, setCurOrder] = useState<IHCInboundOrder>({} as IHCInboundOrder)
                ...
                columns={[
                    ...
                    },
                    {
                        title: '订单类型', dataIndex: 'order_type_code', key: 'order_type_code', width: '120px', render: (value, record, index) => {
                            return Object.keys(OrderTypes)[Object.values(OrderTypes).indexOf(value)] || "INBOUND";
                        }
                    },
