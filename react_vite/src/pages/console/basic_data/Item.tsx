        ...
        <div style={{ width: '85vw', height: '90vh' }}>
            <Table<IHCItem>
                ...
                columns={[
                    ...
                    { title: '扩展码1', dataIndex: 'item_extend_code1', key: 'item_extend_code1', align: 'center', width: '120px', },
                    { title: '扩展码2', dataIndex: 'item_extend_code2', key: 'item_extend_code2', align: 'center', width: '120px', },
                    { title: '长度(mm)', dataIndex: 'item_length', key: 'item_length', align: 'center', width: '120px', },
                    { title: '宽度(mm)', dataIndex: 'item_width', key: 'item_width', align: 'center', width: '120px', },
                    { title: '高度(mm)', dataIndex: 'item_height', key: 'item_height', align: 'center', width: '120px', },
                    { title: '体积(mm³)', dataIndex: 'item_volume', key: 'item_volume', align: 'center', width: '120px', },
                    { title: '重量(g)', dataIndex: 'item_weight', key: 'item_weight', align: 'center', width: '120px', },
                    { title: '包装单位', dataIndex: 'package_unit', key: 'package_unit', align: 'center', width: '120px', },
                    // { title: '供应商', dataIndex: 'supplier_as_lot', key: 'supplier_as_lot', align: 'center', width: '120px', },
                    { title: '满箱数量', dataIndex: 'max_qty_per_box', key: 'max_qty_per_box', align: 'center', width: '120px', },
                    { title: 'abc类型', dataIndex: 'abc_type', key: 'abc_type', align: 'center', width: '120px', },
                    // { title: '序列号', dataIndex: 'has_serial_no', key: 'has_serial_no', align: 'center', width: '120px', },
                    // { title: '属性1', dataIndex: 'lot_prop1_as_lot', key: 'lot_prop1_as_lot', align: 'center', width: '120px', },
                    // { title: '属性2', dataIndex: 'lot_prop2_as_lot', key: 'lot_prop2_as_lot', align: 'center', width: '120px', },
                    // { title: '属性3', dataIndex: 'lot_prop3_as_lot', key: 'lot_prop3_as_lot', align: 'center', width: '120px', },
                    // { title: '统计周期', dataIndex: 'count_cycle_days', key: 'count_cycle_days', align: 'center', width: '120px', },
                    // { title: '生产时期', dataIndex: 'production_date_as_lot', key: 'production_date_as_lot', align: 'center', width: '120px', },
                    // { title: '混合生产日期', dataIndex: 'production_date_mixed_days', key: 'production_date_mixed_days', align: 'center', width: '120px', },
                    // { title: '存储策略', dataIndex: 'storage_strategy', key: 'storage_strategy', align: 'center', width: '120px', },
                    // { title: '混合存储天数', dataIndex: 'storage_date_mixed_days', key: 'storage_date_mixed_days', align: 'center', width: '120px', },
                    // { title: '存储日期', dataIndex: 'storage_date_as_lot', key: 'storage_date_as_lot', align: 'center', width: '120px', },
                    // { title: '分拣策略', dataIndex: 'pick_strategy', key: 'pick_strategy', align: 'center', width: '120px', },
                    // { title: '有效混合天数', dataIndex: 'expiry_date_mixed_days', key: 'expiry_date_mixed_days', align: 'center', width: '120px', },
                    // { title: '有效日期', dataIndex: 'expiry_date_as_lot', key: 'expiry_date_as_lot', align: 'center', width: '120px', },
